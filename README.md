...
- **Key Topics:**
  - 6-stage incident response lifecycle (NIST framework)
...
- **What I Learned:**
  ...
  - How to document security events
  - MITRE ATT&CK framework basics
  
- **Real-World Application:**
  - Detect incidents using SIEM
  - Investigate with evidence preservation
...
#### **Module 7: Intro To Network Traffic Analysis**
- Network protocols
- Wireshark fundamentals
- Identifying suspicious traffic
- Network-based threat detection

#### **Module 8: Intermediate Network Traffic Analysis**
- Advanced packet analysis
- Protocol deep-dives
- Anomaly detection
- Investigation techniques

#### **Module 9: Working With IDS/IPS**
- Intrusion Detection Systems
- IPS deployment and tuning
- Alert management
- Integration with SIEM

#### **Module 10: Introduction To Malware Analysis**
- Malware behavior analysis
- Static vs. dynamic analysis
- Sandbox investigation
- Indicators of malware

#### **Module 11: JavaScript Deobfuscation**
- Obfuscated code analysis
- Deobfuscation techniques
- Threat hunting for malicious scripts
...
#### **Module 13: Introduction To Digital Forensics**
- Forensic investigation methodology
- Evidence preservation
- Timeline analysis
- Forensic reporting

#### **Module 14: Detecting Windows Attacks With Splunk**
- Windows-specific threat detection
- Splunk queries for Windows events
...
- ✅ Shows systematic technical training (not random YouTube)
- ✅ Demonstrates hands-on lab completion
- ✅ Proves you can communicate technical findings
- ✅ Shows job-specific knowledge (what SOC analysts actually do)
- ✅ Public proof of skills and commitment
...
- Use progression to understand SOC complexity
- Reference real-world attack scenarios
...
*This portfolio is actively maintained. New module documentation added as coursework is completed.*
